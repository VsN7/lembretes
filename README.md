...
.![Lembretes](https://cdn.awsli.com.br/600x450/164/164016/produto/15385277/289d5ed70c.jpg)

## Descrição

Esse é um projeto WEB desenvolvido com foco em PHP, fazendo assim a interação entre o back e frontEnd, foi utilizado o framework bootstrap para auxiliar na estilização e o banco de dados MySQL.
...
.![tabelas](https://uploaddeimagens.com.br/images/002/034/101/full/tabelas.PNG?1555086706)

## PHP Tela de gerencia de lembretes (BackEnd)
...
<?php
 ...
 `````
 ## HTML tela de gerencia de lembretes(FrontEnd)
